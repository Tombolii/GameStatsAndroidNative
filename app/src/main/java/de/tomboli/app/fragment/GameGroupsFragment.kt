package de.tomboli.app.fragment
...
/**
 * Fragment to display GameGroups
 */
class GameGroupsFragment : Fragment() {

    private var _binding: GameGroupsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = GameGroupsBinding.inflate(inflater, container, false)
        return binding.root
